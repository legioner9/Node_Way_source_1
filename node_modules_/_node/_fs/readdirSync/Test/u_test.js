...
const readdirSync = ini_fs.readdirSync;
...
readdirSync.utest = true; // first priority : mutation from utest
readdirSync.exit = true; // second priority : return console.log(e)
...
const u1 = readdirSync ( __dirname );
const u2 = readdirSync ( false_path );
