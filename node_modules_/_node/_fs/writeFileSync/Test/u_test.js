...
// fn.module = module;
ini_fs.s_writeFileSync.exit = true;
ini_fs.s_writeFileSync.utest = true;
debugger
const arr = Fs.readdirSync ( __dirname );

const true_path = Path.join ( __dirname, 'new_file' );
const false_path = Path.join ( __dirname, 'false', 'new_file' );
