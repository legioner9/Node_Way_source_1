...
mkdirSync.fname = 's_mkdirSync';

// s_mkdirSync.mode.log = true;
// s_mkdirSync.mode.deb = true;
const u1 = mkdirSync ( true_path );
const u2 = mkdirSync ( false_path );
