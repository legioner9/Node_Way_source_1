...
const arr_res = arr.map ( item => {
    const is = stats ( Path.join ( __dirname, item ) );
    return is;
} );


const u1 = stats ( 'rrr' );
// const u2 = stats(__dirname);

if ( !u1 ) console.log ( '>>> stats err_test fail' );
// if ( !u2 ) console.log ( '>>> stats arr_0 fail' );
