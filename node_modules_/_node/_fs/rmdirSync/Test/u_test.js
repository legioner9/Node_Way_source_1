...
// ini_fs.mode.log = true;
// ini_fs.mode.deb = true;
// fn.mode.debLog = true;
// fn.mode.logFs = true;
// fn.stack = true;
// fn.exit = true;
...
const s_readdirSync = ini_fs.s_readdirSync;

// s_readdirSync.mode.log = true;
// s_readdirSync.mode.deb = true;

const false_path = Path.join ( __dirname, 'rrr' );

s_readdirSync.utest = true; // first priority : mutation from utest
s_readdirSync.exit = true; // second priority : return console.log(e)
...
const u1 = s_readdirSync ( __dirname );
const u2 = s_readdirSync ( false_path );
...
//
if ( !u1 ) console.log ( '>>> s_readdirSync normal read fail' );
if ( !u2 ) console.log ( '>>> s_readdirSync normal err read fail' );
