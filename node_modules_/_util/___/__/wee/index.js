...
const Func_examp = ( err_object = new Error ( 'default error' ),
                     ...
                     obj_warn_log = {
                         warn_log: d => console.log ( d.message ),
    ...
    if ( env_object.WARN ) {
        return obj_warn_log.warn_log ( err_object );
    }

    if ( env_object.EXIT ) {
        obj_warn_log.exit_log ( err_object );
        process.exit ( 0 );
    }
    if ( env_object.ERR ) {
        obj_warn_log.err_log ( err_object );
        throw new Error ( err_object );
    }
