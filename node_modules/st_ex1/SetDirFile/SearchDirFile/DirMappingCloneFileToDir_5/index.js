...
const cloneDirStructFromArr_deep_2 = ( parent_path, arr_init, dev ) => {
    arr_init.map ( ( item, index, arr ) => {
        ...
        if ( item.match ( /^###_/ ) ) {
            create_level_2_from2 ( parent_path, item, index, arr_init, dev );
        }
 ...
 */
const DirMappingCloneFileToDir_5 = ( par, name_init_file ) => {

    const dev = DirMappingCloneFileToDir_5.mode === 'debug' || global.mode === 'debug';
...
DirMappingCloneFileToDir_5.help = `ModuleFunc = () => {}`;

DirMappingCloneFileToDir_5.call = () => console.log ( DirMappingCloneFileToDir_5 );

DirMappingCloneFileToDir_5.mode = 'production';

module.exports = DirMappingCloneFileToDir_5;
