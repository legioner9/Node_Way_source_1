 ...
 */
const DirMappingCloneFileToDir_6 = ( par, name_init_file ) => {

    const dev = DirMappingCloneFileToDir_6.mode === 'debug' || global.mode === 'debug';
...
DirMappingCloneFileToDir_6.help = `ModuleFunc = () => {}`;

DirMappingCloneFileToDir_6.call = () => console.log ( DirMappingCloneFileToDir_6 );

DirMappingCloneFileToDir_6.mode = 'production';

module.exports = DirMappingCloneFileToDir_6;
