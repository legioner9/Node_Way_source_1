...
const DirMappingCloneFileToDir_2_level = ( par ) => {
    const arr_dir = Fs.readdirSync ( par );
    const dev = DirMappingCloneFileToDir_2_level.mode === 'debug' || global.mode === 'debug';
...
DirMappingCloneFileToDir_2_level.help = `ModuleFunc = () => {}`;

DirMappingCloneFileToDir_2_level.call = () => console.log ( DirMappingCloneFileToDir );

DirMappingCloneFileToDir_2_level.mode = 'production';

module.exports = DirMappingCloneFileToDir_2_level;
