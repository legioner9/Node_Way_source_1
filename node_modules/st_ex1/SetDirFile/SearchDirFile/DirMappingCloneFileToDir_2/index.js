...
const cloneDirStructFromArr = ( parent_path, arr_init, dev ) => {
    arr_init.map ( item => {
        ...
        create_dir ( path_dir_item, '_src', dev );

        // const path_dir_item_src = Path.join ( path_dir_item, '_src' );
        //
        // if ( dev ) console.log ( `${ !Fs.existsSync ( path_dir_item_src ) } it' our !Fs.existsSync ( create_src )` );
        //
        // if ( !Fs.existsSync ( path_dir_item_src ) ) {
        //     Fs.mkdir ( path_dir_item_src, err => {
        //         if ( err ) {
        //             console.error ( err );
        //         }
        //     } );
        ...
        // const path_file_item_www = Path.join ( path_dir_item, 'www.md' );
        // Fs.writeFile ( path_file_item_www, '', ( err ) => {
        //     if ( err ) {
        //         console.error ( err );
        //     }
        //     //файл записан успешно
        //     if ( dev ) console.log ( `${ path_file_item_www } file www.md is create` );
        // } );
        ...
        // const path_file_item_readme = Path.join ( path_dir_item, 'ReadMe.md' );
        // Fs.writeFile ( path_file_item_readme, '', ( err ) => {
        //     if ( err ) {
        //         console.error ( err );
        //     }
        //     //файл записан успешно
        //     if ( dev ) console.log ( `${ path_file_item_readme } file ReadMe.md is create` );
        // } );
