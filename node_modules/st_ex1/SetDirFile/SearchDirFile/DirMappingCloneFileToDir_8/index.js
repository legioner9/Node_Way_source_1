 ...
 */
const DirMappingCloneFileToDir_8 = ( par, name_init_file ) => {

    const dev = DirMappingCloneFileToDir_8.mode === 'debug' || global.mode === 'debug';
...
DirMappingCloneFileToDir_8.help = `ModuleFunc = () => {}`;

DirMappingCloneFileToDir_8.call = () => console.log ( DirMappingCloneFileToDir_8 );

DirMappingCloneFileToDir_8.mode = 'production';

module.exports = DirMappingCloneFileToDir_8;
