...
const { createTechDir_4, debLog, debLogToFile, createArrLikeGit } = require ( 'st_ini' );
// const debLogToFile = { deb: false, log: false, logFs:false };

createTechDir_4.mode = { deb: false, log: true, logFs: true };
...
debugger
createTechDir_4 ( __dirname, createArrLikeGit );
