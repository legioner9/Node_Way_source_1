...
const { createTechDir_4, debLog, createArrLikeGit } = require ( 'st_ini' );
// const DebLog = { deb: false, log: false };

createTechDir_4.mode = { deb: false, log: true };

// const arr_creator = [ 'A', 'B', [ 'B', 'BA' ,'BB'] ];
// const arr_creator = [ 'A', 'B', [ 'B0', 'BA' ,'BB',['BB0','BBA','BBB'],['empty_dir']] ];
const arr_creator = [ ['A','B',['AA','BB',['AAA',['BBB'],['AAAA']]]], ['B'], ['C'] ];
