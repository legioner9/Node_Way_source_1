...
const { l_log, l_deb, l_log_deb, l_fsLog, l_stack, dirDeepOptions } = Ini_deep;
...
AtOut_fm.at = fn => {
    ...
    const ENV = { MODE, EVENT, MODULE, PRESET, EXTER, INNER, STACK };
    // start signal of fn
...
AtOut_fm.at_set1 = fn => {
    const { l_log, l_deb, l_log_deb, l_fsLog, l_stack, dirDeepOptions } = require ( 'st_ini_deep1' );
